...
def form_insert_post():
    ...
    sql_insert_query = """INSERT INTO tblBaseball_Players (fldName,fldLat,fldLong,fldCountry,fldAbbreviation,fldCapitalStatus,fldPopulation) VALUES (%s, %s,%s, %s,%s, %s,%s) """
